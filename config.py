...
VEHICLE_CATEGORIES = {
    ...
    "14FT DIESEL": ["14FT DIESEL"],
    "VAN DIESEL (GOODS VAN)": [
        "HINO DUTRO 2.8", "HINO XZU710", "TOYOTA DYNA 2.8", "TOYOTA DYNA 3.0",
        "NISSAN CABSTAR", "ISUZU NHR / NJR", "ISUZU NPR85", "ISUZU NMR85", "ISUZU NNR85",
        "MITSUBISHI FEA01", "MITSUBISHI FEA21", "KIA 2500"
    ],
    "VAN PETROL (GOODS VAN)": [
        "TOYOTA HIACE 3.0M", "TOYOTA HIACE 3.0A", "TOYOTA HIACE 2.8A", "TOYOTA HIACE 2.0",
        "NISSAN NV350 2.5M", "NISSAN NV350 2.0", "NISSAN NV200 1.5M", "NISSAN NV200 1.6A",
        "HONDA N-VAN", "VAN DIESEL", "VAN PETROL"
    ]
}
