"""
Create data exactly matching PDF format
Ablink SGCarmart Scraper by Oneiros Indonesia

PDF format has: Price + Units for each year
"""
...
print("="*80)
print("CREATING PDF-FORMAT DATA")
print("By Oneiros Indonesia")
print("="*80)

# Data exactly from PDF - with units per year
data = {
    'Vehicle': [
...
print("\n[1/4] Data created with units per year")
...
excel_file = f"{output_folder}/pdf_format_{timestamp}.xlsx"
df.to_excel(excel_file, index=False)
print(f"\n[2/4] Excel saved: {excel_file}")

# Generate PDF-style HTML with enhanced generator that handles _price and _units columns
print("\n[3/4] Generating PDF-style HTML...")

# Create enhanced HTML directly
from pdf_enhanced_generator import PDFEnhancedGenerator
generator = PDFEnhancedGenerator()
...
print("\n" + "="*80)
print("PDF-FORMAT REPORT GENERATED!")
print("="*80)
print("\nCHECK BROWSER - Should match PDF exactly:")
print("  [OK] DATE header")
print("  [OK] Each year has Price + Units columns")
print("  [OK] Category section headers")
print("  [OK] Color-coded DIFF")
print("  [OK] Compact table")
print("  [OK] Print-ready")
