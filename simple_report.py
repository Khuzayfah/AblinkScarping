"""
Ablink SGCarmart Scraper - Simple Report Generator
By Oneiros Indonesia

Simple report with:
- Grey design (like PDF)
- Save CSV, Excel, PDF
- No charts, no colors - just clean report
"""
...
print("="*70)
print("Ablink SGCarmart Scraper")
...
# Save CSV
print("\n[2/4] Saving CSV...")
csv_file = f"{output_folder}/report_{timestamp}.csv"
df.to_csv(csv_file, index=False, encoding='utf-8-sig')
print(f"      Saved: {csv_file}")

# Save Excel
print("\n[3/4] Saving Excel...")
excel_file = f"{output_folder}/report_{timestamp}.xlsx"
df.to_excel(excel_file, index=False)
print(f"      Saved: {excel_file}")

# Generate HTML (for PDF) - SOFT NATURAL COLORS
print("\n[4/4] Generating HTML report with soft colors...")
...
print("For PDF: Press Ctrl+P and 'Save as PDF'")
print("="*70)
